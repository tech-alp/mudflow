...
int main()
{
    ...
    if (!QDir().mkpath(root + QStringLiteral("/.runmark"))
            || !writeFile(config, R"({"version":1,"name":"t","worktree_root":"w","repos":[{"name":"r","path":"missing-repo","base":{"remote":"origin","branch":"main"}}],"plan":{"paths":["plan.md"]},"task_id_pattern":"MF-\\d+"})")) return 1;
